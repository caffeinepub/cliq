...
import { useGetMessages, useSendMessage, useGetConversations, useGetUserProfile } from '../hooks/useQueries';
...
export function ConversationPage() {
  ...
  const handleSendMessage = async () => {
    ...
    try {
      await sendMessage.mutateAsync({ conversationId: BigInt(conversationId), content: messageContent });
      setMessageContent('');
    } catch (error: any) {
    ...
    <div className="flex flex-col h-[calc(100vh-4rem)] md:h-screen">
      ...
      <div className="border-t p-4">
        <div className="flex gap-2">
          ...
          />
          <Button onClick={handleSendMessage} disabled={sendMessage.isPending || !messageContent.trim()}>
